        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="index.php" class="navbar-brand">
                    <h1 class="m-0 text-secondary"><span class="text-primary">CLEAN</span>ME</h1>
                </a>
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">Pangani, Nairobi, Kenya</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-primary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">vinecentochieng@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex text-left">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">+254707955352</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container pt-0 pt-lg-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <h1 class="mb-4">We Are Quality Laundry Provider In Your Town</h1>
                    <h5 class="font-weight-medium font-italic mb-4">We offer quality work.</h5>
                    <p class="mb-2">Best in town in terms of quality</p>
                    <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 m-0 my-lg-5 pt-0 pt-lg-5 pr-lg-5">
                    ...
                    <p>Quality Work at a affordable price</p>
                    <div class="row">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel">
                 <div class="testimonial-item">
                    <img class="position-relative rounded-circle bg-white shadow mx-auto" src="img/v.png" style="width: 100px; height: 100px; padding: 12px; margin-bottom: -50px; z-index: 1;" alt="">
                    <div class="bg-light text-center p-4 pt-0">
                        <h5 class="font-weight-medium mt-5">ochieng</h5>
                        <p class="text-muted font-italic">Fullstack Web Developer</p>
                        <p class="m-0">Best in the market</p>
                    </div>
                </div>
                 <div class="testimonial-item">
                    <img class="position-relative rounded-circle bg-white shadow mx-auto" src="img/v.png" style="width: 100px; height: 100px; padding: 12px; margin-bottom: -50px; z-index: 1;" alt="">
   ...
   <!--  <div class="container-fluid mt-5 pb-2">
    ...
    <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href=""><h1 class="text-secondary mb-3"><span class="text-white">CLEAN</span>ME</h1></a>
                <p>Best in town</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>Pangani, Nairobi, Kenya</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+254707955352</p>
                <p><i class="fa fa-envelope mr-2"></i>vinecentocieng@gmail.com.com</p>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
    ...
    <div class="container-fluid bg-dark text-white py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center text-white">
            &copy; <a class="text-white font-weight-medium" href="#">Clean Me</a>. All Rights Reserved. Designed by
            <a class="text-white font-weight-medium" href="https://freewebsitecode.com">Vincent ochieng</a>
        </p>
    </div>
    <!-- Footer End -->
